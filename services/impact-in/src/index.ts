...
async function start() {
  ...
  app.get('/', async (request, reply) => {
    return {
      service: 'impact-in',
      version: '2.0.0', // Updated for Worker 4 ingest functionality
      description: 'Bidirectional impact data service for external CSR platforms and internal TEEI systems',
      platforms: ['benevity', 'goodera', 'workday', 'kintell', 'upskilling', 'buddy', 'mentorship'],
      endpoints: {
