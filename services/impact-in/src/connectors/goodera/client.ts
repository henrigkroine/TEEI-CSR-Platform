...
/**
 * Goodera API client with rate limiting and batch support
 */
export class GooderaClient {
  ...
  /**
   * Send single impact record to Goodera API
   */
  ...
  /**
   * Send batch of impact records to Goodera API (max 100 records)
   */
