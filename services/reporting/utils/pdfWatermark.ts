 ...
 */
export function generateReportId(companyId: string, period: string): string {
 ...
 */
export function createIDStampHTML(config: IDStampConfig): string {
 ...
 */
export function createWatermarkHTML(config: PDFWatermarkConfig): string {
 ...
 */
function getWatermarkStyles(
  position: PDFWatermarkConfig['position'],
  opacity: number,
  fontSize: number,
  color: string
): string {
 ...
 */
export function createSignatureBlockHTML(config: SignatureBlockConfig): string {
 ...
 */
export function createMethodologyDisclaimerHTML(): string {
  return `
    <div style="
      margin-top: 24px;
      padding: 12px;
 ...
 */
export function validateWatermarkConfig(config: PDFWatermarkConfig): {
  valid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
