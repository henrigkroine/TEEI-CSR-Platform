...
import type { GeneratedReport, PDFExportOptions, CompanyTheme } from '../types';
...
/**
 * Cache configuration for rendered PDFs
 */
...
const defaultCacheConfig: PDFCacheConfig = {
 ...
 */
export async function getCachedOrRenderPDF(
  reportId: string,
  report: GeneratedReport,
  options: PDFExportOptions = {}
): Promise<PDFRenderResult> {
