 ...
 */
export const sroiCalculations = pgTable('sroi_calculations', {
 ...
 */
export const sroiValuationWeights = pgTable('sroi_valuation_weights', {
    id: uuid('id').defaultRandom().primaryKey(),
 ...
 */
export const visCalculations = pgTable('vis_calculations', {
    id: uuid('id').defaultRandom().primaryKey(),
 ...
 */
export const visActivityLog = pgTable('vis_activity_log', {
    id: uuid('id').defaultRandom().primaryKey(),
    userId: uuid('user_id').notNull(),
...
//# sourceMappingURL=impact-metrics.js.map