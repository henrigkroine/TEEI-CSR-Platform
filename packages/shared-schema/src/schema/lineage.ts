 ...
 */
export const metricLineage = pgTable(
  'metric_lineage',
  {
    ...
    sourceEventIds: jsonb('source_event_ids').notNull().$type<string[]>(), // Array of event IDs from buddy_system_events
...
export interface DerivedMetric {
  ...
  contribution?: number; // Points or value contributed by this event
}
