 ...
 */
export const buddySystemEvents = pgTable('buddy_system_events', {
    id: uuid('id').defaultRandom().primaryKey(),
    ...
    derivedMetrics: jsonb('derived_metrics').default('[]').$type(), // Tracks which metrics have been derived from this event
    createdAt: timestamp('created_at', { withTimezone: true }).defaultNow().notNull(),
}, (table) => ({
