 ...
 */
export function isCampaignCompleted(campaign) {
    return campaign.status === 'completed' || campaign.status === 'closed';
}
/**
 * Check if campaign can be started
 */
export function canStartCampaign(campaign) {
    return ['draft', 'planned', 'recruiting'].includes(campaign.status);
}
/**
 * Check if campaign can be paused
 */
export function canPauseCampaign(campaign) {
 ...
 */
export function isCampaignNearCapacity(campaign, threshold = 0.8) {
 ...
 */
export function isCampaignOverCapacity(campaign) {
    const utilization = parseFloat(campaign.capacityUtilization);
 ...
 */
export function hasBudgetRemaining(campaign) {
 ...
 */
export function isCampaignInDateRange(campaign, date = new Date()) {
