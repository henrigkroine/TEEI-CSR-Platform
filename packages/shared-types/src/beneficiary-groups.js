...
export const CreateBeneficiaryGroupSchema = z.object({
    ...
    name: z.string()
        ...
        .refine((val) => !val.toLowerCase().includes('email') && !val.toLowerCase().includes('@'), "Group name must not contain email addresses or individual identifiers"),
 ...
 */
export function meetsMinimumSize(group, currentSize) {
    if (group.minGroupSize !== null && currentSize < group.minGroupSize) {
        return false;
    }
    return true;
}
//# sourceMappingURL=beneficiary-groups.js.map