...
export const LanguageConfigSchema = z.object({
  ...
  (data) => data.classSizeMin <= data.classSizeMax,
  {
...
export const CreateProgramTemplateSchema = z.object({
  ...
  (data) => data.defaultMinParticipants <= data.defaultMaxParticipants,
  {
 ...
 */
export function isMentorshipConfig(config: any): config is MentorshipConfig {
 ...
 */
export function isLanguageConfig(config: any): config is LanguageConfig {
 ...
 */
export function isBuddyConfig(config: any): config is BuddyConfig {
 ...
 */
export function isUpskillingConfig(config: any): config is UpskillingConfig {
 ...
 */
export function isWeeiConfig(config: any): config is WeeiConfig {
 ...
 */
export function getConfigByType(template: ProgramTemplate): ProgramTemplateConfig {
  return template.defaultConfig as ProgramTemplateConfig;
}

/**
 * Check if template is deprecated
 */
export function isTemplateDeprecated(template: ProgramTemplate): boolean {
 ...
 */
export function isTemplateAvailable(template: ProgramTemplate): boolean {
 ...
 */
export function isTemplateSuitableForGroup(
