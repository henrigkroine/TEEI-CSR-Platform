 ...
 */
export function validateDeckDefinition(data) {
    return DeckDefinitionSchema.parse(data);
}
/**
 * Safely validates deck definition without throwing
 */
export function safeParseDeckDefinition(data) {
 ...
 */
export function isValidSlideBlockType(type) {
 ...
 * @throws {ZodError} If validation fails
 */
export function validateSlideBlock(data) {
 ...
 * @throws {ZodError} If validation fails
 */
export function validateDeckTheme(data) {
 ...
 * @throws {ZodError} If validation fails
 */
export function validateGenerateDeckRequest(data) {
 ...
 * @throws {ZodError} If validation fails
 */
export function validateExportDeckRequest(data) {
